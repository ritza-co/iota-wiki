...
<table>
  <tbody>
      ...
      <td>
        <ul>
          <li>Introducing an idea by posting in the
            <a href="https://govern.iota.org/"> forum </a></li>
          
          <li>Approval by <a href="#governance-forum-moderators"> moderator </a></li>
      ...
      <td>
        <ul>
          ...
          <li>Follows a defined structure of the
            <a href="#412-governance-proposal-template-phase-2--3--emergency-proposal"> governance template </a></li>
          
          <li>Approval by
            <a href="#governance-forum-moderators"> moderator </a>      </li>
      ...
      <td>
        <ul>
          <li>The post must discuss one of the
            <a href="/learn/governance/governance-scope"> parameters that are open for governance </a>   </li>
       
          <li>The post must follow the rules set for
            <a href="#guaranteeing-stability---resubmital-delay"> resubmittal delays </a>  </li>
      ...
      <td>
        <ul>
          ...
          <li>Follows a defined structure as described in the
            <a href="#412-governance-proposal-template-phase-2--3--emergency-proposal"> proposal template </a>    </li>
    ...
    <tr>
      ...
      <td>
        <ul>
          <li>Poll duration is seven days  </li>
      ...
      <td>
        <ul>
          ...
          <li>Must reach 5% quorum of
            <a href="#maximum-achievable-votes"> maximum achieveable votes </a>  </li>
      ...
      <td>
        <ul>
          ...
          <li>Does not talk about the
            <a href="/learn/governance/governance-scope"> parameters open for governance </a> </li>
          ...
          <li>Proposal conflicts with the
            <a href="#guaranteeing-stability---resubmital-delay"> resubmittal delay rules </a>          </li>

          <li>Proposal does not meet the
            <a href="#42-shimmer-governance-framework-guiding-principles"> guiding principles. </a>  </li>
      ...
      <td>
        <ul>
          ...
          <li>Does not reach 5% quorum of
            <a href="#maximum-achievable-votes">maximum achievable votes </a></li>
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td>
        tl1 requires topics entered: 3<p>tl1 requires read posts: 3</p>
    ...
    <tr>
      <td>
        Time a phase 2 proposal must be submitted in advance to the moderators
        to be included in the next phase 2 poll round
      </td>
    ...
    <tr>
      ...
      <td>
        As defined in the section 4.3 [Governance Forum Moderators][tasks and
        responsibilities]
      </td>
    </tr>
  </tbody>
